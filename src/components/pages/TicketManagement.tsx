...
const TicketManagement: React.FC = () => {
  ...
  const { data: users } = useListUsers({ page: 0, size: 100 });
      ...
      {displayTickets && (
        <Pagination>
          <PaginationContent>
            ...
            {Array.from({ length: displayTickets.totalPages }, (_, i) => (
            ...
            <PaginationItem>
              <PaginationNext 
                onClick={() => setCurrentPage(Math.min(displayTickets.totalPages - 1, currentPage + 1))}
                className={currentPage === displayTickets.totalPages - 1 ? 'pointer-events-none opacity-50' : 'cursor-pointer'}
              />
            </PaginationItem>
          </PaginationContent>
        </Pagination>
      ...
      <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
        <DialogContent className="max-w-2xl">
          ...
          <DialogFooter>
            ...
            <Button onClick={handleCreateTicket} disabled={createTicket.isLoading}>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="max-w-2xl">
          ...
          <DialogFooter>
            ...
            <Button onClick={handleUpdateTicket} disabled={updateTicket.isLoading}>
      ...
      <Dialog open={isAssignDialogOpen} onOpenChange={setIsAssignDialogOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleAssignTicket} disabled={assignTicket.isLoading}>
              {assignTicket.isLoading ? 'Assigning...' : 'Assign Ticket'}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={isResolveDialogOpen} onOpenChange={setIsResolveDialogOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleResolveTicket} disabled={resolveTicket.isLoading}>
              {resolveTicket.isLoading ? 'Resolving...' : 'Resolve Ticket'}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={isCommentDialogOpen} onOpenChange={setIsCommentDialogOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleAddComment} disabled={addComment.isLoading}>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          {tickets?.totalElements || 0} tickets found
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Table>
