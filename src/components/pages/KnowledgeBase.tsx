...
const KnowledgeBase: React.FC = () => {
  ...
  const { data: categories } = useGetCategories({ productId: selectedProduct });
      ...
      <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          <DialogFooter>
            ...
            <Button onClick={handleCreateArticle} disabled={createArticle.isLoading}>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          <DialogFooter>
            ...
            <Button onClick={handleUpdateArticle} disabled={updateArticle.isLoading}>
              {updateArticle.isLoading ? 'Updating...' : 'Update Article'}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
